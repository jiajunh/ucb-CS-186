...
class BNLJOperator extends JoinOperator {
    ...
    private class BNLJIterator extends JoinIterator {
        ...
        private void fetchNextLeftBlock() {
            ...
            int buffer = numBuffers - 2;
            this.leftRecordIterator = BNLJOperator.this.getBlockIterator(this.getLeftTableName(), this.leftIterator, buffer);
        ...
        private void fetchNextRecord() {
            // TODO(proj3_part1): implement
            this.nextRecord = null;
            if (this.leftRecord == null && this.leftRecordIterator == null) { throw new NoSuchElementException("No new record to fetch"); }
            do {
